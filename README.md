...
If you encounter any problems, make sure that you follow the instructions concerning "renv" as written above, i.e. install and use R 4.4.1, then run "install.packages("renv")" and then "renv::restore()" first (or delete the comments ("#") in lines 11 and 14 in `main.R` and run that script).
